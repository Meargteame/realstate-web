...
export default function Home() {
  return (
    <div className="w-full">
      ...
      <section className="relative h-[500px] md:h-[600px] w-full flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full text-white">
          <motion.div
            ...
            className="max-w-xl"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Where Entrepreneurs Thrive™</h2>
            <p className="text-xl mb-10 text-gray-200">Join a team of doers, dreamers, and entrepreneurs</p>
      ...
      {/* Informed Section */}
      <section className="py-24 px-6 bg-kw-gray">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">Informed, empowered, successful.</h2>
      ...
      {/* Trending Section */}
      <section className="relative h-[500px] w-full flex items-center justify-end overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-center z-0"
          style={{ 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex justify-end">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="max-w-md text-right text-white"
          >
            <h2 className="text-4xl font-bold mb-6">Curious about what’s trending in your neighborhood?</h2>
            <p className="text-xl mb-10 text-gray-200">Download our app for real estate insights, on demand.</p>
            <Button className="bg-kw-footer hover:bg-kw-dark text-white rounded-full px-8 h-12 font-bold text-[13px]">
              Download the App
            </Button>
          </motion.div>
